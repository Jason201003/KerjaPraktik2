...
<body>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <form id="extraOptionsForm" class="row g-3 bg-white p-4 rounded ">
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="Sarapan" id="sarapan" class="form-check-input" data-name="Sarapan" data-harga="100000">
                ...
                <form id="rincianHarga" class="row g-3 bg-white p-4 rounded">
                    ...
                    <div class="d-flex justify-content-between w-100">
                        <h5>Harga Kamar</h5>
                        <p id="hargaKamar" class="mb-0" style="font-weight: bold;">IDR 200.000</p>
                    </div>
                    <p style="font-weight: 100">(1x) Superior Double (1 Malam)</p>
                    <div id="rincianHargaContainer"></div>
                    <hr class="mt-3 mb-3">
                    <div class="d-flex justify-content-between w-100">
                        <h5 style="font-weight: bold">Total Harga</h5>
                        <p id="totalHarga" class="mb-0" style="font-weight: bold;">IDR 200.000</p>
                    </div>
            ...
            <div class="box-white col-lg-6 bg-white p-4">
                ...
                <img src="{{ asset('img/Kamar_superior.jpg') }}"alt="Gambar Deskripsi" class="img-fluid mb-3">
                <h5 style="font-weight: bold;">Superior Double</h5>
                <div class="d-flex flex-column mb-3" style="gap: 10px;">
                    <small style="display: flex; align-items: center; font-weight: 600;">
                        <i class="fa fa-bed me-3 fa-lg" style="color: #FEA116"></i>1 Beds
                    </small>
                    <small style="display: flex; align-items: center; font-weight: 600;">
                ...
                <small style="display: flex; align-items: center; font-weight: bold; font-size: 15px">
                    ...
                    Harga Kamar
                    <span style="margin-left: 140px; color: #333; font-size: 18px">IDR 200.000</span>
                </small>
    ...
    const baseHarga = 200000; // Harga kamar awal
