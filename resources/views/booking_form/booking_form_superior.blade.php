    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-lg-6">
                ...
                <form id="rincianHarga" class="row g-3 bg-white p-4 rounded">
                    ...
                    <div class="d-flex justify-content-between w-100">
                        <h5>Harga Kamar</h5>
                        <p id="hargaKamar" class="mb-0" style="font-weight: bold;">IDR 183.929</p>
                    </div>
                    <p style="font-weight: 100">(1x) Superior (1 Malam)</p>
                    <div id="rincianHargaContainer"></div>
                    <hr class="mt-3 mb-3">
                    <div class="d-flex justify-content-between w-100">
                        <h5 style="font-weight: bold">Total Harga</h5>
                        <p id="totalHarga" class="mb-0" style="font-weight: bold;">IDR 183.929</p>
                    </div>
            ...
            <div class="box-white col-lg-6 bg-white p-4">
                ...
                <h5 style="font-weight: bold;">Superior</h5>
                ...
                <small style="display: flex; align-items: center; font-weight: bold; font-size: 15px">
                    ...
                    Harga Kamar
                    <span style="margin-left: 140px; color: #333; font-size: 18px">IDR 183.929</span>
                </small>
