            ...
            <div class="card-body">
                <form action="{{ route('manager.kamars.update', $kamar) }}" method="POST">
                    ...
                    <!-- Tipe Bed -->
                     <div class="form-group">
                        ...
                        <select name="tipe_bed" class="form-control" id="tipe_bed">
                            ...
                            <option value="Twin Size">Twin Size Bed</option>
                        </select>
                     </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fasilitas" name="fasilitas" placeholder="{{ __('Fasilitas') }}" value="{{ old('kapasitas') }}" required/>
                    </div>

                    <!-- Deskripsi -->
                    <div class="form-group">
                        <label for="deskripsi">{{ __('Deskripsi') }}</label>
                        <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="{{ __('Deskripsi') }}" value="{{ old('deskripsi') }}" required/>
                    </div>
