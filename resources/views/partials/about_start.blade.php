    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">AMIRA HOTEL</span></h1>
                <p class="mb-4">Setiap momen di dirancang untuk menghadirkan relaksasi, kemudahan, dan sentuhan kemewahan, menjadikannya tempat peristirahatan sempurna bagi para tamu yang mencari pengalaman istimewa. </p>
